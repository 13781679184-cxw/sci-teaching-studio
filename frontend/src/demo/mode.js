/** Static showcase uses the real my-ppt workspace snapshot. */
export const IS_DEMO = import.meta.env.VITE_DEMO === 'true'

export const DEMO_PROJECT_ID = 'my-ppt'

/** Prefill for the public demo create home (matches packed showcase). */
